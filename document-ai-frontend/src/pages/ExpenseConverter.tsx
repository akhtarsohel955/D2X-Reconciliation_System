        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <Link 
                to="/" 
                className="flex items-center space-x-2 text-blue-600 hover:text-blue-700 font-medium transition-colors duration-300 hover-lift"
              >
            ...
            <div className="flex items-center space-x-4">
              <div className="w-12 h-12 bg-ocean-gradient rounded-2xl flex items-center justify-center shadow-lg hover-lift">
                <span className="text-white font-bold text-xl">📄</span>
              </div>
              <div>
                <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Expense Converter</h1>
                <p className="text-sm text-gray-600">Convert invoices and receipts to Excel format</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="glass backdrop-blur-md rounded-3xl border border-white/20 shadow-2xl p-10 mb-12 hover-lift">
            ...
            <div className="mb-8 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-blue-900 mb-1">Guest Mode</h3>
          ...
          <div className="text-center mb-10">
            <div className="w-20 h-20 bg-ocean-gradient rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg">
            ...
            <p className="text-gray-600 text-xl leading-relaxed max-w-2xl mx-auto">
              Upload your invoice, receipt, or bill and we'll convert it to a structured Excel spreadsheet using advanced AI technology
            </p>
          </div>
            ...
            <div className="mt-10 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <button
                  ...
                  className="px-10 py-5 bg-ocean-gradient hover:opacity-90 disabled:opacity-50 text-white font-semibold rounded-2xl transition-all duration-300 shadow-xl hover:shadow-2xl disabled:cursor-not-allowed flex items-center justify-center hover:scale-105"
                >
                  {isProcessing ? (
                    <>
        ...
        {/* Info Section */}
        <div className="bg-ocean-gradient rounded-3xl p-12 text-white shadow-2xl">
          <h3 className="text-3xl font-bold mb-8 text-center">How Expense Conversion Works</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mx-auto mb-6 backdrop-blur-sm">
                <span className="text-3xl">📄</span>
              </div>
              <h4 className="font-semibold mb-3 text-xl">Upload Document</h4>
              <p className="text-blue-100 leading-relaxed">Upload your PDF, JPG, or PNG expense document securely</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mx-auto mb-6 backdrop-blur-sm">
                <span className="text-3xl">🤖</span>
              ...
              <p className="text-blue-100 leading-relaxed">AWS Textract extracts and structures your data intelligently</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mx-auto mb-6 backdrop-blur-sm">
                <span className="text-3xl">📊</span>
              ...
              <p className="text-blue-100 leading-relaxed">Download your perfectly organized Excel spreadsheet</p>
            </div>
          </div>
        </div>
      </main>
